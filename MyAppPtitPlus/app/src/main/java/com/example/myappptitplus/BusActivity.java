...
public class BusActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        xebus xb = (xebus)intent.getSerializableExtra("xb");
        diemdi = new LatLng(xb.getVidodi(),xb.getKinhdodi());
        diemden = new LatLng(xb.getVidoden(),xb.getKinhden());

        // Add a marker in Sydney and move the camera
        LatLng sydney = new LatLng(20.981666, 105.787456);
        mMap.addMarker(new MarkerOptions().position(sydney).title("Ptit"));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(sydney));

        LatLng origin = diemdi;
        LatLng dest = diemden;
